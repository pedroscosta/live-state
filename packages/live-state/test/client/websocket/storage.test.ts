...
describe("KVStorage", () => {
  ...
  describe("sorting functionality", () => {
    beforeEach(() => {
      // Setup storage with mock db for sorting tests
      (storage as any).db = mockDB;
    });

    test("should handle queries with sort parameter", async () => {
      const mockData = {
        user1: { name: "Charlie", age: 30 },
      ...
      // Mock the query processing that would happen in the websocket store
      const query = {
        resource: "users",
        where: {},
        include: {},
    ...
    test("should handle queries with multiple sort parameters", async () => {
      const mockData = {
        user1: { name: "Alice", age: 30, role: "admin" },
        user2: { name: "Alice", age: 25, role: "user" },
        user3: { name: "Bob", age: 35, role: "admin" },
      };
    ...
    test("should handle queries with descending sort", async () => {
      const mockData = {
    ...
    test("should handle queries with sort on numeric fields", async () => {
      const mockData = {
        user1: { name: "Alice", age: 25, score: 85 },
        user2: { name: "Bob", age: 30, score: 92 },
    ...
    test("should handle queries with sort on date fields", async () => {
      const mockData = {
        user1: { name: "Alice", createdAt: "2023-01-01" },
        user2: { name: "Bob", createdAt: "2023-02-01" },
        user3: { name: "Charlie", createdAt: "2023-03-01" },
      };
    ...
    test("should handle queries with sort when no sort parameter provided", async () => {
      const mockData = {
        user1: { name: "Alice", age: 25 },
        user2: { name: "Bob", age: 30 },
        user3: { name: "Charlie", age: 35 },
    ...
    test("should handle empty data with sort parameter", async () => {
      mockDB.getAllRecords = vi.fn().mockResolvedValue({});
    ...
    test("should handle sort with null/undefined values", async () => {
      const mockData = {
        user1: { name: "Alice", age: null },
        user2: { name: "Bob", age: 30 },
        user3: { name: "Charlie", age: undefined },
      };
    ...
    test("should handle sort with mixed data types", async () => {
      const mockData = {
        user1: { name: "Alice", value: "100" },
        user2: { name: "Bob", value: 200 },
        user3: { name: "Charlie", value: "50" },
      };
