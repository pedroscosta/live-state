...
Live State is currently in alpha. It's not recommended for production use, but it's being used to power [FrontDesk](https://tryfrontdesk.app), which is a SaaS platform for managing customer support being built by the same team.
